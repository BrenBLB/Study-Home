...
<div class="principal">
    ...
    <div class="menu">
        ...
        <a href="./selecTarefa.php" target="Caixa" class="tarefas"><i class="fa-solid fa-sliders icons"></i>Tarefas</a>
        ...
        <a href="./configP.php" target="Caixa"><button class="config">Configurações</a>
    ...
    <div class="iframe">
        <iframe class="formataiframe" src="./selecTarefa.php" name="Caixa"></iframe>
    </div>
