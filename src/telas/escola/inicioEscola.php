...
<?php 
    ...
    $img = '../../../public/arquivos/img/'.$_SESSION["id"].'escola';
...
<div class="principal">
    ...
    <div class="menu">
        ...
        <a href="./listar.php" target="Caixa" class="tarefas"><i class="fa-solid fa-sliders icons"></i>Listagem</a>
        
        <a href="./cadastrar.php" target="Caixa" class="atualidades"><i class="fa-solid fa-user-graduate icons"></i>Cadastros</a>

        <a href="../calendario.html" target="Caixa" class="calendario"><i class="fa-solid fa-calendar-days icons"></i>Calendário</a>

        <a href="./configEscola.php" target="Caixa"><button class="config">Configurações</a>
    ...
    <div class="iframe">
        <iframe class="formataiframe" src="./listar.php" name="Caixa"></iframe>
    </div>
