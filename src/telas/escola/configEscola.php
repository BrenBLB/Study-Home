...
$comandoSql = "select * from escola where id = '$id'";
...
<body style="background: #E5E5E5">
    <div class="principal">
        <div class="conta">
            <form action="../../conexao/alteraDadosEscola.php" method="post" enctype="multipart/form-data">
                ...
                <label style="font-weight: bold;">Nome Escola</label><br>
                ...
                <label style="font-weight: bold;">CNPJ</label><br>
                <input class="btn btn-light" type="text" name="cnpj" id="cnpj" disabled value="<?php echo $cnpj ?>"><br><br>
